...
'database.redis.cache.max_retries','database.redis.cache.backoff_algorithm','database.redis.cache.backoff_base','database.redis.cache.backoff_cap','dompdf.show_warnings',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\MediManage\\public\\storage','fortify.guard','fortify.middleware',
...
'reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','services.postmark.token','services.resend.key',
...
'two-factor.disable','two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home','about','articles','article',
'public.prescription','public.prescription.validation','dashboard','profile.edit',
'profile.update','profile.destroy','password.edit','password.update','appearance.edit',
'two-factor.show','sessions.index','sessions.destroy','register','register.store',
'password.request','password.email','password.reset','password.store','verification.notice',
'verification.verify','verification.send','admin.roles.index','admin.roles.edit','admin.roles.update',
'admin.roles.togglePermission','admin.permissions.index','admin.permissions.show','admin.permissions.edit','admin.permissions.update',
'admin.users.index','admin.users.show','admin.users.edit','admin.users.update','admin.users.destroy','patient_info.simpleSearch','patient_info.createPartial','patient_info.storePartial',
'patient_info.search','patient_info.show','patient_info.newAccount','patient_info.storeNewAccount','patient_info.associateAccount',
'patient_info.edit','patient_info.update','employee_info.doctorSimpleSearch','prescriptions.myPrescriptions','prescriptions.index',
'prescriptions.show','prescriptions.edit','prescriptions.update','prescriptions.generatePdf','medicalRecords.myRecord',
'medicalRecords.index','medicalRecords.create','medicalRecords.store','medicalRecords.show','medicalRecords.edit',
'medicalRecords.update','medicalRecords.destroy','medicalRecords.generatePdf','medicalRecords.entries.create','medicalRecords.entries.store',
'medicalRecords.entries.edit','medicalRecords.entries.update','appointments.patient.index','appointments.doctor.index','appointments.update.status',
'appointments.create','appointments.store','articles.index','articles.my','articles.create',
'articles.store','articles.edit','articles.update','articles.destroy','categories.index',
'categories.create','categories.store','categories.edit','categories.update','categories.destroy',
'invoices.myInvoices','invoices.generatePdf','storage.local',);
        registerArgumentsSet('views', 
'app','emails.account_association','emails.new_account','pdfs.invoice','pdfs.medical-record',
'pdfs.prescription','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
