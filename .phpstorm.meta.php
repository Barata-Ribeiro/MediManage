...
'filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\MediManage\\public\\storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'two-factor.disable','two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home','articles','article','dashboard','profile.edit','profile.update','profile.destroy','password.edit',
...
'prescriptions.index','medicalRecords.patientSimpleSearch','medicalRecords.index','medicalRecords.create','medicalRecords.store',
'medicalRecords.show','medicalRecords.edit','medicalRecords.update','medicalRecords.destroy','medicalRecords.generatePdf',
'storage.local',);
