...
'two-factor.disable','two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home','articles','article','public.prescription',
'public.prescription.validation','dashboard','profile.edit','profile.update',
'profile.destroy','password.edit','password.update','appearance.edit','two-factor.show',
'sessions.index','sessions.destroy','register','register.store','password.request',
'password.email','password.reset','password.store','verification.notice','verification.verify',
'verification.send','admin.roles.index','admin.roles.edit','admin.roles.update','admin.roles.togglePermission',
'admin.permissions.index','admin.users.index','admin.users.show','admin.users.edit','admin.users.update',
'admin.users.destroy','patient_info.createPartial','patient_info.storePartial','patient_info.search','patient_info.show',
'patient_info.newAccount','patient_info.storeNewAccount','prescriptions.index','prescriptions.show','prescriptions.edit',
'prescriptions.update','prescriptions.generatePdf','prescriptions.my','medicalRecords.patientSimpleSearch','medicalRecords.index',
'medicalRecords.create','medicalRecords.store','medicalRecords.show','medicalRecords.edit','medicalRecords.update',
'medicalRecords.destroy','medicalRecords.generatePdf','articles.index','articles.my','articles.create',
