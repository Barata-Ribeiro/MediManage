...
'admin.users.index','admin.users.show','admin.users.edit','admin.users.update','admin.users.destroy','patient_info.simpleSearch','patient_info.createPartial',
'patient_info.storePartial','patient_info.search','patient_info.show','patient_info.newAccount','patient_info.storeNewAccount',
'patient_info.associateAccount','patient_info.edit','patient_info.update','employee_info.doctorSimpleSearch','employee_info.index',
'employee_info.create','employee_info.store','employee_info.show','prescriptions.myPrescriptions','prescriptions.index',
...
'invoices.index','invoices.myInvoices','invoices.generatePdf','storage.local',);
