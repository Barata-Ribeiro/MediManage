...
'debugbar.queries.explain','login','login.store','logout','password.confirm',
...
'two-factor.regenerate-recovery-codes','home','about','articles',
'article','public.prescription','public.prescription.validation','dashboard',
'profile.edit','profile.update','profile.destroy','password.edit','password.update',
'appearance.edit','two-factor.show','sessions.index','sessions.destroy','register',
'register.store','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','admin.roles.index','admin.roles.edit',
'admin.roles.update','admin.roles.togglePermission','admin.permissions.index','admin.permissions.show','admin.permissions.edit',
'admin.permissions.update','admin.users.index','admin.users.show','admin.users.edit','admin.users.update',
'admin.users.destroy','patient_info.simpleSearch',
'patient_info.createPartial','patient_info.storePartial','patient_info.search','patient_info.show','patient_info.newAccount',
'patient_info.storeNewAccount','patient_info.associateAccount','patient_info.edit','patient_info.update','employee_info.doctorSimpleSearch',
'employee_info.index','employee_info.create','employee_info.store','employee_info.show','employee_info.edit',
'employee_info.update','prescriptions.myPrescriptions','prescriptions.index','prescriptions.show','prescriptions.edit',
'prescriptions.update','prescriptions.generatePdf','medicalRecords.myRecord','medicalRecords.index','medicalRecords.create',
'medicalRecords.store','medicalRecords.show','medicalRecords.edit','medicalRecords.update','medicalRecords.destroy',
'medicalRecords.generatePdf','medicalRecords.entries.create','medicalRecords.entries.store','medicalRecords.entries.edit','medicalRecords.entries.update',
'appointments.patient.index','appointments.doctor.index','appointments.update.status','appointments.create','appointments.store',
'articles.index','articles.my','articles.create','articles.store','articles.edit',
