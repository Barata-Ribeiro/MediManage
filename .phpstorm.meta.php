...
'app','app.Agent','audit.enabled','audit.implementation','audit.user.morph_prefix',
...
'two-factor.disable','two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home','articles.index','articles.show','dashboard','profile.edit','profile.update','profile.destroy','password.edit',
...
'admin.users.destroy','prescriptions.index','prescriptions.my','medicalRecords.patientSimpleSearch','medicalRecords.index',
'medicalRecords.create','medicalRecords.store','medicalRecords.show','medicalRecords.edit','medicalRecords.update',
'medicalRecords.destroy','medicalRecords.generatePdf','articles.my','articles.create','articles.store',
...
'app','pdfs.medical-record','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
