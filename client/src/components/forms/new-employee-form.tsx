...
export default function NewEmployeeForm() {
    const [registration, setRegistration] = useState<NewEmployeeResponse | null>(null)
        ...
        <form action={formAction} onSubmit={onSubmit} className="space-y-6">
            <Field className="border-b border-neutral-300 pb-6">
                ...
                <Description className="max-w-lg text-sm text-neutral-700">
                    <strong className="text-red-600">Important!</strong> The type of employee you are registering. This
                    will determine the permissions and access level of the employee.
                </Description>
                <Select
                    id="accountType"
                    name="accountType"
            ...
            <Field>
                <Label htmlFor="fullName" className="block font-heading text-sm font-medium leading-6 text-neutral-900">
                    Full Name
                </Label>
                <Input
                    type="text"
            ...
            <Field>
                <Label htmlFor="email" className="block font-heading text-sm font-medium leading-6 text-neutral-900">
                    Email
                </Label>
                <Input
                    type="email"
            ...
            <Field>
                <Label htmlFor="phone" className="block font-heading text-sm font-medium leading-6 text-neutral-900">
                    Phone
                </Label>
                <Input
                    type="tel"
            ...
            <Field>
                <Label htmlFor="address" className="block font-heading text-sm font-medium leading-6 text-neutral-900">
                    Address
                </Label>
                <Input
                    type="text"
            ...
            <Fieldset
                ...
                {isDoctor && (
                    <SimpleAlert>
                        <strong>Important!</strong> The following information is required for doctors only. Please fill
                        in the fields below with the doctor&apos;s information.
                    </SimpleAlert>
                )}
