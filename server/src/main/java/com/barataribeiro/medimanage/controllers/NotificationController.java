...
public class NotificationController {
    ...
    @Operation(summary = "Get all user notifications",
               ...
               tags = {"notifications"})
    @GetMapping("/{userId}")
    public ResponseEntity<RestResponseDTO<Page<NotificationDTO>>> getAllUserNotifications(
        ...
        Page<NotificationDTO> response = notificationService
                .getAllUserNotifications(userId, isRead, page, perPage, direction, orderBy, principal);
    ...
    public ResponseEntity<RestResponseDTO<List<NotificationDTO>>> getLatestUserNotifications(
            @PathVariable String userId,
            Principal principal) {
    ...
    public ResponseEntity<RestResponseDTO<NotificationDTO>> getNotification(@PathVariable String userId,
    ...
    public ResponseEntity<RestResponseDTO<NotificationDTO>> changeNotificationStatus(@PathVariable String userId,
                                                                                     @PathVariable
    ...
    @Operation(summary = "Change notification status in batch",
               ...
               tags = {"notifications"})
    @PatchMapping("/{userId}")
    public ResponseEntity<RestResponseDTO<List<NotificationDTO>>> changeNotificationStatusInBatch(
            @PathVariable String userId,
            @RequestBody @Valid
        ...
        List<NotificationDTO> response = notificationService
                .changeNotificationStatusInBatch(userId, notifications, principal);
        return ResponseEntity.ok(new RestResponseDTO<>(HttpStatus.OK,
                                                       HttpStatus.OK.value(),
    ...
    public ResponseEntity<RestResponseDTO<Void>> deleteNotification(@PathVariable String userId,
                                                                    @PathVariable String notificationId,
                                                                    Principal principal) {
    ...
    public ResponseEntity<RestResponseDTO<Void>> deleteNotificationsInBatch(@PathVariable String userId,
                                                                            @RequestParam
