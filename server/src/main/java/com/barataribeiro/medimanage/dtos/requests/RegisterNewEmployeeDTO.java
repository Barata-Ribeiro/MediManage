...
public record RegisterNewEmployeeDTO(@NotBlank
                                     ...
                                     @Pattern(regexp = "^\\d{6}-\\d{2}/[A-Z]{2}$", message = "You must provide a " +
                                             "valid " +
                                             "registration number.")
                                     ...
                                     @NotBlank
                                     @Pattern(regexp = "PATIENT|ASSISTANT|DOCTOR|ADMINISTRATOR", message = "Account " +
                                             "type" +
