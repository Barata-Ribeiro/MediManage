...
namespace Illuminate\Support\Facades {
    ...
    class Schema {
        ...
        /**
         * Determine if the given table has given column.
         *
         * @param string $table
         ...
         *
         * @param string $table
         * @return \Illuminate\Database\Schema\list<array{name: string, column: list<string>, type: string, unique: bool, primary: bool}>
         * @static
         */
        ...
        /**
         * Drop column from a table schema.
         *
         * @param string $table
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
        ...
        /**
         * Add a "where" clause comparing two column to the query.
         *
        ...
        /**
         * Add an "or where" clause comparing two column to the query.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression|string|array $first
         * @param string|null $operator
         * @param string|null $second
        ...
        /**
         * Add a where between statement using column to the query.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression|string $column
         * @param string $boolean
         * @param bool $not
        ...
        /**
         * Add an or where between statement using column to the query.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression|string $column
         * @return \Illuminate\Database\Eloquent\Builder<static>
         * @static
        ...
        /**
         * Add a where not between statement using column to the query.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression|string $column
         * @param string $boolean
         * @return \Illuminate\Database\Eloquent\Builder<static>
        ...
        /**
         * Add an or where not between statement using column to the query.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression|string $column
         * @return \Illuminate\Database\Eloquent\Builder<static>
         * @static
        ...
        /**
         * Add a where between column statement using a value to the query.
         *
         * @param mixed $value
        ...
        /**
         * Add an or where between column statement using a value to the query.
         *
         * @param mixed $value
         * @param array{\Illuminate\Contracts\Database\Query\Expression|string, \Illuminate\Contracts\Database\Query\Expression|string} $columns
         * @return \Illuminate\Database\Eloquent\Builder<static>
        ...
        /**
         * Add a where not between column statement using a value to the query.
         *
         * @param mixed $value
         * @param array{\Illuminate\Contracts\Database\Query\Expression|string, \Illuminate\Contracts\Database\Query\Expression|string} $columns
         * @param string $boolean
        ...
        /**
         * Add an or where not between column statement using a value to the query.
         *
         * @param mixed $value
         * @param array{\Illuminate\Contracts\Database\Query\Expression|string, \Illuminate\Contracts\Database\Query\Expression|string} $columns
         * @return \Illuminate\Database\Eloquent\Builder<static>
        ...
        /**
         * Add a "where" clause to the query for multiple column with "and" conditions between them.
         *
        ...
        /**
         * Add an "or where" clause to the query for multiple column with "and" conditions between them.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns
         * @param mixed $operator
         * @param mixed $value
        ...
        /**
         * Add a "where" clause to the query for multiple column with "or" conditions between them.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns
         * @param mixed $operator
         * @param mixed $value
        ...
        /**
         * Add an "or where" clause to the query for multiple column with "or" conditions between them.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns
         * @param mixed $operator
         * @param mixed $value
        ...
        /**
         * Add a "where not" clause to the query for multiple column where none of the conditions should be true.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns
         * @param mixed $operator
         * @param mixed $value
        ...
        /**
         * Add an "or where not" clause to the query for multiple column where none of the conditions should be true.
         *
         * @param \Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns
         * @param mixed $operator
         * @param mixed $value
        ...
        /**
         * Get all of the query builder's column in a text-only array with all expressions evaluated.
         *
         * @return list<string>
         * @static
         */
