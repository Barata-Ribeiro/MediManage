...
namespace tbQuar\Facades {
    ...
    class Quar {
         ...
         * @static
         */
        public static function withText($text, $position = 'bottom')
        {
            /** @var \tbQuar\Generate $instance */
            return $instance->withText($text, $position);
        }
         ...
         * @static
         */
        public static function configureText($callback)
        {
            /** @var \tbQuar\Generate $instance */
            return $instance->configureText($callback);
        }

        /**
         * Rotates the current text overlay object
         *
         * @return \tbQuar\TextOverlay|null
         * @static
         */
        public static function getTextOverlay()
        {
            /** @var \tbQuar\Generate $instance */
            return $instance->getTextOverlay();
        }
