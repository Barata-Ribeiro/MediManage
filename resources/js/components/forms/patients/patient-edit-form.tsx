...
export default function PatientEditForm({ errors, date, onChange, patient }: Readonly<PatientEditFormProps>) {
                ...
                <FieldGroup className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <Field>
                        ...
                        <Input
                            ...
                            type="text"
                            defaultValue={patient.insurance_company}
                    ...
                    <Field>
                        ...
                        <Input
                            ...
                            type="text"
                            defaultValue={patient.insurance_member_id_number}
                    ...
                    <Field>
                        ...
                        <Input
                            ...
                            type="text"
                            defaultValue={patient.insurance_group_number}
                    ...
                    <Field>
                        ...
                        <Input
                            ...
                            type="text"
                            defaultValue={patient.insurance_policy_number}
                ...
                <FieldGroup className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <Field className="sm:col-span-2">
                        ...
                        <Input
                            ...
                            type="tel"
                            defaultValue={patient.emergency_contact_phone_number}
                ...
                <FieldGroup className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <Field>
                        ...
                        <Input
                            ...
                            name="past_illnesses"
                            type="text"
                            defaultValue={patient.past_illnesses}
                    ...
                    <Field>
                        ...
                        <Input
                            ...
                            type="text"
                            defaultValue={patient.family_medical_history}
