...
Route::middleware(['auth'])->prefix('appointments')->group(function () {
    Route::get('/my-appointments', [AppointmentController::class, 'indexByPatient'])->name('appointments.patient.index')->middleware('role_or_permission:Patient|appointment.index');
